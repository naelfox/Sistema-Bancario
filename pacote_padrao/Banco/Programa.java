	...
	public static void main(String[] args) {
		...
		do {
			...
			if (x.equals(operacoes[1])) {
				do {
					String y = (String) JOptionPane.showInputDialog(null, "Selecione o tipo de conta", "BancoAnhembi",
							JOptionPane.PLAIN_MESSAGE, null, adcConta, 0);
			...
			if (x.equals(operacoes[2])) {
				...
				if (localizador == null) {
					...
					int resp = JOptionPane.showOptionDialog(null,
							"Deseja remover essa conta?\n" + operacaoContas.buscarConta(numeroConta), "Remover conta",
							JOptionPane.YES_OPTION, JOptionPane.NO_OPTION, null, confirmacao, 0);
			...
			if (x.equals(operacoes[4])) {
				...
				if (localizador == null) {
					...
					double valorDepositado = Double
							.parseDouble(JOptionPane.showInputDialog(operacaoContas.buscarConta(numeroConta) + "\n\nInforme um valor para depósito"));
					int resp = JOptionPane.showOptionDialog(null,
							"Deseja efetuar o depósito na seguinte conta\n" + operacaoContas.buscarConta(numeroConta)
			...
			if (x.equals(operacoes[5])) {
				...
				int numeroContaFonte = Integer.parseInt(JOptionPane.showInputDialog(null,
						"Informe o número da conta fonte", "Transferência em conta", JOptionPane.INFORMATION_MESSAGE));
				...
				int resp = JOptionPane.showOptionDialog(null,
						...
						"Transferência em andamento", JOptionPane.YES_OPTION, JOptionPane.NO_OPTION, null, confirmacao,
						0);
				if (resp == JOptionPane.YES_OPTION) {
			...
			if (x.equals(operacoes[6])) {
				String z = (String) JOptionPane.showInputDialog(null, "Selecione uma operação", "O que desejar buscar?",
						JOptionPane.PLAIN_MESSAGE, null, buscar, 0);
				// buscar conta
				if (z.equals(buscar[0])) {
					int numeroConta = Integer.parseInt(JOptionPane.showInputDialog(null, "Informe o número da conta",
							"Buscar conta", JOptionPane.INFORMATION_MESSAGE));
